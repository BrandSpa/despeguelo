...
<head>
	...
	<title>Despéguelo Brandspa</title>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/fonts/stylesheetM.css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/fonts/stylesheetL.css">
